(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusquedaComponent = /** @class */ (function () {
                function BusquedaComponent(activateRouter, _HEROESSERVICE) {
                ...
                BusquedaComponent.prototype.ngOnInit = function () {
                    ...
                    this.activateRouter.params.subscribe(function (params) {
                        _this.termino = params.nombre;
                        _this.heroes = _this._HEROESSERVICE.buscarHeroes(params.nombre);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeroeTarjetaComponent = /** @class */ (function () {
                function HeroeTarjetaComponent(ruta) {
                    this.ruta = ruta;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeroeComponent = /** @class */ (function () {
                function HeroeComponent(activateRouter, _HEROESSERICE) {
                    var _this = this;
                    this.activateRouter = activateRouter;
                    this._HEROESSERICE = _HEROESSERICE;
                    this.heroe = {};
                    this.activateRouter.params.subscribe(function (param) {
                        _this.heroe = _this._HEROESSERICE.getHeroe(param.id);
                    });
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeroesComponent = /** @class */ (function () {
                function HeroesComponent(_HEROESSERVICE, ruta) {
                    this._HEROESSERVICE = _HEROESSERVICE;
                    this.ruta = ruta;
                    this.heroes = [];
                }
            ...
            var HeroesService = /** @class */ (function () {
                ...
                HeroesService.prototype.buscarHeroes = function (termino) {
                    ...
                    for (var i = 0; i < this.heroes.length; i++) {
                        ...
                        heroe.id = i;
                        var tmp = heroe.nombre.toLowerCase();
                        if (tmp.indexOf(termino) >= 0) {
                            heroesArr.push(heroe);
                        }
                    }
